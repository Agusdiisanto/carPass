...
export const DEMO_VEHICLES: DemoVehicle[] = [
  ...
  },
  {
    ...
    color: 'Plata',
    seal: 0,
    reason: 'Transferida, con motor y capot reemplazados',
    km: 40_000,
    services: 3,
    vtv: 1,
    siniestros: 0,
  },
  {
    ...
    color: 'Azul',
    seal: 0,
    reason: 'Transferido, con puerta y caja reemplazadas',
    km: 60_000,
    services: 4,
    vtv: 1,
    siniestros: 1,
  },
  {
    ...
    color: 'Blanco',
    seal: 1,
    reason: 'Transferido, baul reemplazado y VTV con observaciones',
    km: 32_000,
    services: 3,
    vtv: 1,
    siniestros: 1,
