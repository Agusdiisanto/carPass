...
- Quality seal: public computed summary for VIN lookups.
...
5. Define read methods required by public lookup and frontend.
...
- Public VIN reads must not require wallet connection.
